...
const { tiffBasePath: generatePath, baseNcPath: basePath } = global.CONFIG['phenomenaConfig'].pathMap
//tos_O1_2001-2002 over      sresa1b_ncar_ccsm3-example       Temperature_20201208       chinasea_201812_el  hawaii_soest_720b_f42f_6234_01a4_a802_3d07.nc
//读取文件名称 
//ncep_global_353d_67d4_f1bf
// const file = "salt.hr.annltm"
// ncToTiff(file)
async function ncToGeoTiff(file) {
    return new Promise((resolve, reject) => {
        const data = fs.readFileSync(basePath + file + ".nc");
